...
public static class COMPLETE_ALL_SIDE_QUESTS
{
    ...
    public static DredgeAchievementId id = DredgeAchievementId.COMPLETE_ALL_SIDE_QUESTS;
    public static string steamId = "";
    public static int playStationId = 19;
    public static string xboxId = "";
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<AchievementCondition> evaluationConditions = COMPLETE_ALL_SIDE_QUESTSInstance.evaluationConditions;
}
