...
public static class COMPLETE_CHAPTER_1
{
    ...
    public static DredgeAchievementId id = DredgeAchievementId.COMPLETE_CHAPTER_1;
    public static string steamId = "";
    public static int playStationId = 3;
    public static string xboxId = "";
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<AchievementCondition> evaluationConditions = COMPLETE_CHAPTER_1Instance.evaluationConditions;
}
