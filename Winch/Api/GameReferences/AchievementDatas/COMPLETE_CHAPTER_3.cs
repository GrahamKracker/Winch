...
public static class COMPLETE_CHAPTER_3
{
    public static AchievementData COMPLETE_CHAPTER_3Instance = (AchievementData)System.Linq.Enumerable.First(ScriptableObjectInstances.AchievementDatas, x => x.name == "COMPLETE_CHAPTER_3");
    public static DredgeAchievementId id = DredgeAchievementId.COMPLETE_CHAPTER_3;
    public static string steamId = "";
    public static int playStationId = 5;
    public static string xboxId = "";
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<AchievementCondition> evaluationConditions = COMPLETE_CHAPTER_3Instance.evaluationConditions;
}
