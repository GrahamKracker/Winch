...
public static class COMPLETE_CHAPTER_5
{
    public static AchievementData COMPLETE_CHAPTER_5Instance = (AchievementData)System.Linq.Enumerable.First(ScriptableObjectInstances.AchievementDatas, x => x.name == "COMPLETE_CHAPTER_5");
    public static DredgeAchievementId id = DredgeAchievementId.COMPLETE_CHAPTER_5;
    public static string steamId = "";
    public static int playStationId = 7;
    public static string xboxId = "";
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<AchievementCondition> evaluationConditions = COMPLETE_CHAPTER_5Instance.evaluationConditions;
}
