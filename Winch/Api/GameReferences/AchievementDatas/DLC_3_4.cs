...
public static class DLC_3_4
{
    public static AchievementData DLC_3_4Instance = (AchievementData)System.Linq.Enumerable.First(ScriptableObjectInstances.AchievementDatas, x => x.name == "DLC_3_4");
    public static DredgeAchievementId id = DredgeAchievementId.DLC_3_4;
    public static string steamId = "";
    public static int playStationId = 43;
    public static string xboxId = "";
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<AchievementCondition> evaluationConditions = DLC_3_4Instance.evaluationConditions;
}
