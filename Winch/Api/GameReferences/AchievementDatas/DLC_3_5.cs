...
public static class DLC_3_5
{
    public static AchievementData DLC_3_5Instance = (AchievementData)System.Linq.Enumerable.First(ScriptableObjectInstances.AchievementDatas, x => x.name == "DLC_3_5");
    public static DredgeAchievementId id = DredgeAchievementId.DLC_3_5;
    public static string steamId = "";
    public static int playStationId = 44;
    public static string xboxId = "";
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<AchievementCondition> evaluationConditions = DLC_3_5Instance.evaluationConditions;
}
