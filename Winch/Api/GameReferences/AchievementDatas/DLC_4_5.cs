...
public static class DLC_4_5
{
    public static AchievementData DLC_4_5Instance = (AchievementData)System.Linq.Enumerable.First(ScriptableObjectInstances.AchievementDatas, x => x.name == "DLC_4_5");
    public static DredgeAchievementId id = DredgeAchievementId.DLC_4_5;
    ...
    public static string xboxId = "";
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<AchievementCondition> evaluationConditions = DLC_4_5Instance.evaluationConditions;
}
