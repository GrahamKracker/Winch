...
public static class HULL_3
{
    ...
    public static DredgeAchievementId id = DredgeAchievementId.HULL_3;
    public static string steamId = "";
    public static int playStationId = 37;
    public static string xboxId = "";
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<AchievementCondition> evaluationConditions = HULL_3Instance.evaluationConditions;
}
