...
public static class HULL_4
{
    public static AchievementData HULL_4Instance = (AchievementData)System.Linq.Enumerable.First(ScriptableObjectInstances.AchievementDatas, x => x.name == "HULL_4");
    public static DredgeAchievementId id = DredgeAchievementId.HULL_4;
    public static string steamId = "";
    public static int playStationId = 38;
    public static string xboxId = "";
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<AchievementCondition> evaluationConditions = HULL_4Instance.evaluationConditions;
}
