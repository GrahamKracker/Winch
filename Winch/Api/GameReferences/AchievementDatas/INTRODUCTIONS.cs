...
{
    public static AchievementData INTRODUCTIONSInstance = (AchievementData)System.Linq.Enumerable.First(ScriptableObjectInstances.AchievementDatas, x => x.name == "INTRODUCTIONS");
    public static DredgeAchievementId id = DredgeAchievementId.INTRODUCTIONS;
    public static string steamId = "";
    public static int playStationId = 1;
    public static string xboxId = "";
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<AchievementCondition> evaluationConditions = INTRODUCTIONSInstance.evaluationConditions;
}
