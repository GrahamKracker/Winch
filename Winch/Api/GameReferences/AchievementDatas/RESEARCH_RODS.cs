...
public static class RESEARCH_RODS
{
    public static AchievementData RESEARCH_RODSInstance = (AchievementData)System.Linq.Enumerable.First(ScriptableObjectInstances.AchievementDatas, x => x.name == "RESEARCH_RODS");
    public static DredgeAchievementId id = DredgeAchievementId.RESEARCH_RODS;
    public static string steamId = "";
    public static int playStationId = 23;
    public static string xboxId = "";
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<AchievementCondition> evaluationConditions = RESEARCH_RODSInstance.evaluationConditions;
}
