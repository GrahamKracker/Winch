...
{
    public static GridConfiguration Fishmonger_Delivery1Instance = (GridConfiguration)System.Linq.Enumerable.First(ScriptableObjectInstances.GridConfigurations, x => x.name == "Fishmonger_Delivery1");
     ///<json>
     /// {
     ///    "$content": [
     ///        {
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<CellGroupConfiguration> cellGroupConfigs = Fishmonger_Delivery1Instance.cellGroupConfigs;
