...
{
    public static GridConfiguration TIR_Building_FactoryTier4Instance = (GridConfiguration)System.Linq.Enumerable.First(ScriptableObjectInstances.GridConfigurations, x => x.name == "TIR_Building_FactoryTier4");
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<CellGroupConfiguration> cellGroupConfigs = TIR_Building_FactoryTier4Instance.cellGroupConfigs;
    ...
    public static ItemSubtype mainItemSubtype = ItemSubtype.NONE | ItemSubtype.MATERIAL;
     ...
     ///}
     ///</json>
    public static ItemData mainItemData = TIR_Building_FactoryTier4Instance.mainItemData;
