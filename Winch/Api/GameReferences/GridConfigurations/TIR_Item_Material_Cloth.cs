...
public static class TIR_Item_Material_Cloth
{
    public static GridConfiguration TIR_Item_Material_ClothInstance = (GridConfiguration)System.Linq.Enumerable.First(ScriptableObjectInstances.GridConfigurations, x => x.name == "TIR_Item_Material_Cloth");
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<CellGroupConfiguration> cellGroupConfigs = TIR_Item_Material_ClothInstance.cellGroupConfigs;
    ...
    public static ItemSubtype mainItemSubtype = ItemSubtype.NONE | ItemSubtype.MATERIAL;
     ...
     ///}
     ///</json>
    public static ItemData mainItemData = TIR_Item_Material_ClothInstance.mainItemData;
