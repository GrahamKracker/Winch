...
public static class TIR_Item_RepairPanic
{
    public static GridConfiguration TIR_Item_RepairPanicInstance = (GridConfiguration)System.Linq.Enumerable.First(ScriptableObjectInstances.GridConfigurations, x => x.name == "TIR_Item_RepairPanic");
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<CellGroupConfiguration> cellGroupConfigs = TIR_Item_RepairPanicInstance.cellGroupConfigs;
    ...
    public static ItemSubtype mainItemSubtype = ItemSubtype.NONE | ItemSubtype.GENERAL | ItemSubtype.MATERIAL;
     ...
     ///}
     ///</json>
    public static ItemData mainItemData = TIR_Item_RepairPanicInstance.mainItemData;
