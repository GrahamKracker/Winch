...
public static class Message3
{
    ...
    public static bool hasAdditionalNote = false;
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString additionalNoteKey = Message3Instance.additionalNoteKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
    ...
    public static bool availableInDemo = false;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<Entitlement> entitlementsRequired = Message3Instance.entitlementsRequired;
}
