...
public static class Arrow_Squid_Aberration_1
{
    public static FishItemData Arrow_Squid_Aberration_1Instance = (FishItemData)System.Linq.Enumerable.First(ScriptableObjectInstances.ItemDatas, x => x.name == "Arrow_Squid_Aberration_1");
    ...
    public static float maxSizeCentimeters = 35f;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<FishItemData> aberrations = Arrow_Squid_Aberration_1Instance.aberrations;
    public static bool isAberration = true;
     ...
     ///}
     ///</json>
    public static FishItemData nonAberrationParent = Arrow_Squid_Aberration_1Instance.nonAberrationParent;
    ...
    public static bool canBeInfected = true;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UnityEngine.Vector2Int> cellsExcludedFromDisplayingInfection = Arrow_Squid_Aberration_1Instance.cellsExcludedFromDisplayingInfection;
    ...
    public static System.Decimal value = 32m;
    public static bool hasSellOverride = false;
    public static System.Decimal sellOverrideValue = 0m;
     ///<json>
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.Sprite sprite = Arrow_Squid_Aberration_1Instance.sprite;
    ...
    public static bool isUnderlayItem = false;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UnityEngine.Vector2Int> dimensions = Arrow_Squid_Aberration_1Instance.dimensions;
    ...
    public static string id = "";
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemNameKey = Arrow_Squid_Aberration_1Instance.itemNameKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemDescriptionKey = Arrow_Squid_Aberration_1Instance.itemDescriptionKey;
    public static bool hasAdditionalNote = false;
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString additionalNoteKey = Arrow_Squid_Aberration_1Instance.additionalNoteKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemInsaneTitleKey = Arrow_Squid_Aberration_1Instance.itemInsaneTitleKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemInsaneDescriptionKey = Arrow_Squid_Aberration_1Instance.itemInsaneDescriptionKey;
    public static string linkedDialogueNode = "";
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString dialogueNodeSpecificDescription = Arrow_Squid_Aberration_1Instance.dialogueNodeSpecificDescription;
    ...
    public static UnityEngine.Color tooltipNotesColor = new UnityEngine.Color(1f, 1f, 1f, 1f);
     ...
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.Sprite itemTypeIcon = Arrow_Squid_Aberration_1Instance.itemTypeIcon;
     ///<json>
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.GameObject harvestParticlePrefab = Arrow_Squid_Aberration_1Instance.harvestParticlePrefab;
    ...
    public static bool availableInDemo = true;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<Entitlement> entitlementsRequired = Arrow_Squid_Aberration_1Instance.entitlementsRequired;
}
