...
public static class Barreleye_Aberration_1
{
    public static FishItemData Barreleye_Aberration_1Instance = (FishItemData)System.Linq.Enumerable.First(ScriptableObjectInstances.ItemDatas, x => x.name == "Barreleye_Aberration_1");
    ...
    public static float maxSizeCentimeters = 50f;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<FishItemData> aberrations = Barreleye_Aberration_1Instance.aberrations;
    public static bool isAberration = true;
     ...
     ///}
     ///</json>
    public static FishItemData nonAberrationParent = Barreleye_Aberration_1Instance.nonAberrationParent;
    ...
    public static bool canBeInfected = true;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UnityEngine.Vector2Int> cellsExcludedFromDisplayingInfection = Barreleye_Aberration_1Instance.cellsExcludedFromDisplayingInfection;
    ...
    public static System.Decimal sellOverrideValue = 0m;
     ...
     /// </json>
    public static UnityEngine.Sprite sprite = Barreleye_Aberration_1Instance.sprite;
    ...
    public static bool isUnderlayItem = false;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UnityEngine.Vector2Int> dimensions = Barreleye_Aberration_1Instance.dimensions;
    ...
    public static string id = "";
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemNameKey = Barreleye_Aberration_1Instance.itemNameKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemDescriptionKey = Barreleye_Aberration_1Instance.itemDescriptionKey;
    public static bool hasAdditionalNote = false;
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString additionalNoteKey = Barreleye_Aberration_1Instance.additionalNoteKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemInsaneTitleKey = Barreleye_Aberration_1Instance.itemInsaneTitleKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemInsaneDescriptionKey = Barreleye_Aberration_1Instance.itemInsaneDescriptionKey;
    public static string linkedDialogueNode = "";
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString dialogueNodeSpecificDescription = Barreleye_Aberration_1Instance.dialogueNodeSpecificDescription;
    ...
    public static UnityEngine.Color tooltipNotesColor = new UnityEngine.Color(1f, 1f, 1f, 1f);
     ...
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.Sprite itemTypeIcon = Barreleye_Aberration_1Instance.itemTypeIcon;
     ///<json>
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.GameObject harvestParticlePrefab = Barreleye_Aberration_1Instance.harvestParticlePrefab;
    public static bool overrideHarvestParticleDepth = true;
    public static float harvestParticleDepthOffset = -7f;
    ...
    public static bool availableInDemo = true;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<Entitlement> entitlementsRequired = Barreleye_Aberration_1Instance.entitlementsRequired;
}
