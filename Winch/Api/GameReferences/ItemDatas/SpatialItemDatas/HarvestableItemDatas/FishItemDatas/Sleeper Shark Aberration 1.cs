...
public static class Sleeper_Shark_Aberration_1
{
    public static FishItemData Sleeper_Shark_Aberration_1Instance = (FishItemData)System.Linq.Enumerable.First(ScriptableObjectInstances.ItemDatas, x => x.name == "Sleeper_Shark_Aberration_1");
    public static float minSizeCentimeters = 300f;
    public static float maxSizeCentimeters = 440f;
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<FishItemData> aberrations = Sleeper_Shark_Aberration_1Instance.aberrations;
    public static bool isAberration = true;
     ///<json>
     /// {
     ///    "minSizeCentimeters": 300.0,
     ///    "maxSizeCentimeters": 440.0,
     ///    "aberrations": [
     ///        {
     ///            "minSizeCentimeters": 300.0,
     ///            "maxSizeCentimeters": 440.0,
     ...
     ///            "locationHiddenUntilCaught": true,
     ///            "day": true,
     ///            "night": true,
     ...
     ///}
     ///</json>
    public static FishItemData nonAberrationParent = Sleeper_Shark_Aberration_1Instance.nonAberrationParent;
    ...
    public static bool canBeInfected = true;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UnityEngine.Vector2Int> cellsExcludedFromDisplayingInfection = Sleeper_Shark_Aberration_1Instance.cellsExcludedFromDisplayingInfection;
    ...
    public static System.Decimal value = 700m;
    public static bool hasSellOverride = false;
    public static System.Decimal sellOverrideValue = 0m;
     ///<json>
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.Sprite sprite = Sleeper_Shark_Aberration_1Instance.sprite;
    ...
    public static bool isUnderlayItem = false;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UnityEngine.Vector2Int> dimensions = Sleeper_Shark_Aberration_1Instance.dimensions;
    ...
    public static string id = "";
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemNameKey = Sleeper_Shark_Aberration_1Instance.itemNameKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemDescriptionKey = Sleeper_Shark_Aberration_1Instance.itemDescriptionKey;
    public static bool hasAdditionalNote = false;
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString additionalNoteKey = Sleeper_Shark_Aberration_1Instance.additionalNoteKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemInsaneTitleKey = Sleeper_Shark_Aberration_1Instance.itemInsaneTitleKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemInsaneDescriptionKey = Sleeper_Shark_Aberration_1Instance.itemInsaneDescriptionKey;
    public static string linkedDialogueNode = "";
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString dialogueNodeSpecificDescription = Sleeper_Shark_Aberration_1Instance.dialogueNodeSpecificDescription;
    ...
    public static UnityEngine.Color tooltipNotesColor = new UnityEngine.Color(1f, 1f, 1f, 1f);
     ...
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.Sprite itemTypeIcon = Sleeper_Shark_Aberration_1Instance.itemTypeIcon;
     ///<json>
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.GameObject harvestParticlePrefab = Sleeper_Shark_Aberration_1Instance.harvestParticlePrefab;
    ...
    public static bool availableInDemo = false;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<Entitlement> entitlementsRequired = Sleeper_Shark_Aberration_1Instance.entitlementsRequired;
}
