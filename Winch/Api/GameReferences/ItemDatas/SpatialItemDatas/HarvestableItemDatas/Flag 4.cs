...
public static class Flag_4
{
    public static HarvestableItemData Flag_4Instance = (HarvestableItemData)System.Linq.Enumerable.First(ScriptableObjectInstances.ItemDatas, x => x.name == "Flag_4");
    ...
    public static System.Decimal sellOverrideValue = 0m;
     ...
     /// </json>
    public static UnityEngine.Sprite sprite = Flag_4Instance.sprite;
    ...
    public static bool isUnderlayItem = false;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UnityEngine.Vector2Int> dimensions = Flag_4Instance.dimensions;
    ...
    public static string id = "";
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemNameKey = Flag_4Instance.itemNameKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemDescriptionKey = Flag_4Instance.itemDescriptionKey;
    public static bool hasAdditionalNote = false;
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString additionalNoteKey = Flag_4Instance.additionalNoteKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemInsaneTitleKey = Flag_4Instance.itemInsaneTitleKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemInsaneDescriptionKey = Flag_4Instance.itemInsaneDescriptionKey;
    public static string linkedDialogueNode = "";
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString dialogueNodeSpecificDescription = Flag_4Instance.dialogueNodeSpecificDescription;
    ...
    public static UnityEngine.Color tooltipNotesColor = new UnityEngine.Color(1f, 1f, 1f, 1f);
     ...
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.Sprite itemTypeIcon = Flag_4Instance.itemTypeIcon;
     ///<json>
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.GameObject harvestParticlePrefab = Flag_4Instance.harvestParticlePrefab;
    ...
    public static bool availableInDemo = true;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<Entitlement> entitlementsRequired = Flag_4Instance.entitlementsRequired;
}
