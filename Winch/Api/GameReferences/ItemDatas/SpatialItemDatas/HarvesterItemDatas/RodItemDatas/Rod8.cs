...
public static class Rod8
{
    public static RodItemData Rod8Instance = (RodItemData)System.Linq.Enumerable.First(ScriptableObjectInstances.ItemDatas, x => x.name == "Rod8");
    public static float fishingSpeedModifier = 0.5f;
     ...
     ///}
     ///</json>
    public static HarvestableType[] harvestableTypes = Rod8Instance.harvestableTypes;
    ...
    public static System.Decimal sellOverrideValue = 0m;
     ...
     /// </json>
    public static UnityEngine.Sprite sprite = Rod8Instance.sprite;
    ...
    public static bool isUnderlayItem = false;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UnityEngine.Vector2Int> dimensions = Rod8Instance.dimensions;
    ...
    public static string id = "";
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemNameKey = Rod8Instance.itemNameKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemDescriptionKey = Rod8Instance.itemDescriptionKey;
    public static bool hasAdditionalNote = false;
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString additionalNoteKey = Rod8Instance.additionalNoteKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemInsaneTitleKey = Rod8Instance.itemInsaneTitleKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemInsaneDescriptionKey = Rod8Instance.itemInsaneDescriptionKey;
    public static string linkedDialogueNode = "";
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString dialogueNodeSpecificDescription = Rod8Instance.dialogueNodeSpecificDescription;
    ...
    public static UnityEngine.Color tooltipNotesColor = new UnityEngine.Color(1f, 1f, 1f, 1f);
     ...
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.Sprite itemTypeIcon = Rod8Instance.itemTypeIcon;
     ///<json>
     /// null
     /// </json>
    ...
    public static bool availableInDemo = false;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<Entitlement> entitlementsRequired = Rod8Instance.entitlementsRequired;
}
