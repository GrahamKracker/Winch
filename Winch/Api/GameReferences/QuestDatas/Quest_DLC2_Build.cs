...
public static class Quest_DLC2_Build
{
    public static QuestData Quest_DLC2_BuildInstance = (QuestData)System.Linq.Enumerable.First(ScriptableObjectInstances.QuestDatas, x => x.name == "Quest_DLC2_Build");
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString titleKey = Quest_DLC2_BuildInstance.titleKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString summaryKey = Quest_DLC2_BuildInstance.summaryKey;
     ///<json>
     /// {
     ///    "$content": [
     ///        []
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString[] resolutionKeys = Quest_DLC2_BuildInstance.resolutionKeys;
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<MapMarkerData> mapMarkersToRemoveOnCompletion = Quest_DLC2_BuildInstance.mapMarkersToRemoveOnCompletion;
    public static bool showUnseenIndicators = true;
     ...
     ///                },
     ///                {
     ///                    "buildingTierId": "SCIENCE_LAB_TIER_1",
     ///                    "silent": false,
     ///                    "$type": "BuildingConstructedCondition"
     ///                },
     ///                {
     ...
     ///                },
     ///                {
     ///                    "buildingTierId": "FLEET_SERVICES_TIER_1",
     ///                    "silent": false,
     ///                    "$type": "BuildingConstructedCondition"
     ///                }
     ///            ]
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<QuestStepData> steps = Quest_DLC2_BuildInstance.steps;
     ///<json>
     /// {
     ///    "$content": [
     ///        {
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<QuestData> subquests = Quest_DLC2_BuildInstance.subquests;
     ///<json>
     /// null
     /// </json>
    ...
    public static bool canBeOfferedAutomatically = false;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<QuestStepCondition> offerConditions = Quest_DLC2_BuildInstance.offerConditions;
