...
public static class Quest_DLC2_Build_Sub_FleetServices
{
    public static QuestData Quest_DLC2_Build_Sub_FleetServicesInstance = (QuestData)System.Linq.Enumerable.First(ScriptableObjectInstances.QuestDatas, x => x.name == "Quest_DLC2_Build_Sub_FleetServices");
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString titleKey = Quest_DLC2_Build_Sub_FleetServicesInstance.titleKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString summaryKey = Quest_DLC2_Build_Sub_FleetServicesInstance.summaryKey;
     ///<json>
     /// {
     ///    "$content": [
     ///        []
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString[] resolutionKeys = Quest_DLC2_Build_Sub_FleetServicesInstance.resolutionKeys;
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<MapMarkerData> mapMarkersToRemoveOnCompletion = Quest_DLC2_Build_Sub_FleetServicesInstance.mapMarkersToRemoveOnCompletion;
    public static bool showUnseenIndicators = false;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<QuestStepData> steps = Quest_DLC2_Build_Sub_FleetServicesInstance.steps;
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<QuestData> subquests = Quest_DLC2_Build_Sub_FleetServicesInstance.subquests;
     ///<json>
     /// null
     /// </json>
    ...
    public static bool canBeOfferedAutomatically = false;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<QuestStepCondition> offerConditions = Quest_DLC2_Build_Sub_FleetServicesInstance.offerConditions;
