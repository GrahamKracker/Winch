...
public static class Quest_DLC2_Main
{
    public static QuestData Quest_DLC2_MainInstance = (QuestData)System.Linq.Enumerable.First(ScriptableObjectInstances.QuestDatas, x => x.name == "Quest_DLC2_Main");
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString titleKey = Quest_DLC2_MainInstance.titleKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString summaryKey = Quest_DLC2_MainInstance.summaryKey;
     ///<json>
     /// {
     ///    "$content": [
     ///        []
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString[] resolutionKeys = Quest_DLC2_MainInstance.resolutionKeys;
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<MapMarkerData> mapMarkersToRemoveOnCompletion = Quest_DLC2_MainInstance.mapMarkersToRemoveOnCompletion;
    public static bool showUnseenIndicators = true;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<QuestStepData> steps = Quest_DLC2_MainInstance.steps;
     ///<json>
     /// {
     ///    "$content": [
     ///        {
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<QuestData> subquests = Quest_DLC2_MainInstance.subquests;
     ///<json>
     /// null
     /// </json>
    ...
    public static bool canBeOfferedAutomatically = false;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<QuestStepCondition> offerConditions = Quest_DLC2_MainInstance.offerConditions;
