...
public static class Quest_GrievingFather
{
    public static QuestData Quest_GrievingFatherInstance = (QuestData)System.Linq.Enumerable.First(ScriptableObjectInstances.QuestDatas, x => x.name == "Quest_GrievingFather");
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString titleKey = Quest_GrievingFatherInstance.titleKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString summaryKey = Quest_GrievingFatherInstance.summaryKey;
     ///<json>
     /// {
     ///    "$content": [
     ///        [],
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString[] resolutionKeys = Quest_GrievingFatherInstance.resolutionKeys;
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<MapMarkerData> mapMarkersToRemoveOnCompletion = Quest_GrievingFatherInstance.mapMarkersToRemoveOnCompletion;
    public static bool showUnseenIndicators = true;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<QuestStepData> steps = Quest_GrievingFatherInstance.steps;
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<QuestData> subquests = Quest_GrievingFatherInstance.subquests;
     ///<json>
     /// null
     /// </json>
    ...
    public static bool canBeOfferedAutomatically = false;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<QuestStepCondition> offerConditions = Quest_GrievingFatherInstance.offerConditions;
