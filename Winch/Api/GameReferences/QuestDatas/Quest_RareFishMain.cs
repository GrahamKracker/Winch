...
{
    public static QuestData Quest_RareFishMainInstance = (QuestData)System.Linq.Enumerable.First(ScriptableObjectInstances.QuestDatas, x => x.name == "Quest_RareFishMain");
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString titleKey = Quest_RareFishMainInstance.titleKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString summaryKey = Quest_RareFishMainInstance.summaryKey;
     ///<json>
     /// {
     ///    "$content": [
     ///        []
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString[] resolutionKeys = Quest_RareFishMainInstance.resolutionKeys;
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<MapMarkerData> mapMarkersToRemoveOnCompletion = Quest_RareFishMainInstance.mapMarkersToRemoveOnCompletion;
    public static bool showUnseenIndicators = true;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<QuestStepData> steps = Quest_RareFishMainInstance.steps;
     ///<json>
     /// {
     ///    "$content": [
     ///        {
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<QuestData> subquests = Quest_RareFishMainInstance.subquests;
     ///<json>
     /// null
     /// </json>
    ...
    public static bool canBeOfferedAutomatically = false;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<QuestStepCondition> offerConditions = Quest_RareFishMainInstance.offerConditions;
