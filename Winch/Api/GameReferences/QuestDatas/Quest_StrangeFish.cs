...
public static class Quest_StrangeFish
{
    public static QuestData Quest_StrangeFishInstance = (QuestData)System.Linq.Enumerable.First(ScriptableObjectInstances.QuestDatas, x => x.name == "Quest_StrangeFish");
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString titleKey = Quest_StrangeFishInstance.titleKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString summaryKey = Quest_StrangeFishInstance.summaryKey;
     ///<json>
     /// {
     ///    "$content": [
     ///        []
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString[] resolutionKeys = Quest_StrangeFishInstance.resolutionKeys;
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<MapMarkerData> mapMarkersToRemoveOnCompletion = Quest_StrangeFishInstance.mapMarkersToRemoveOnCompletion;
    public static bool showUnseenIndicators = true;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<QuestStepData> steps = Quest_StrangeFishInstance.steps;
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<QuestData> subquests = Quest_StrangeFishInstance.subquests;
     ///<json>
     /// {
     ///    "mapMarkersToAddOnStart": [],
     ///    "mapMarkersToDeleteOnCompletion": [],
     ...
     ///}
     ///</json>
    public static QuestStepData onOfferedQuestStep = Quest_StrangeFishInstance.onOfferedQuestStep;
    public static bool canBeOfferedAutomatically = true;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<QuestStepCondition> offerConditions = Quest_StrangeFishInstance.offerConditions;
