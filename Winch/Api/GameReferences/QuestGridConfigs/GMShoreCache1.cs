...
public static class GMShoreCache1
{
    public static QuestGridConfig GMShoreCache1Instance = (QuestGridConfig)System.Linq.Enumerable.First(ScriptableObjectInstances.QuestGridConfigs, x => x.name == "GMShoreCache1");
    public static QuestGridExitMode questGridExitMode = QuestGridExitMode.REVISITABLE;
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString titleString = GMShoreCache1Instance.titleString;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString helpStringOverride = GMShoreCache1Instance.helpStringOverride;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString exitPromptOverride = GMShoreCache1Instance.exitPromptOverride;
     ///<json>
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.Sprite backgroundImage = GMShoreCache1Instance.backgroundImage;
    ...
    public static GridKey gridKey = GridKey.GM_SHORE_CACHE_1;
    ...
    public static float startingDurabilityProportion = 1f;
     ...
     ///}
     ///</json>
    public static GridConfiguration gridConfiguration = GMShoreCache1Instance.gridConfiguration;
     ///<json>
     /// {
     ...
     ///}
     ///</json>
    public static SerializableGrid presetGrid = GMShoreCache1Instance.presetGrid;
    public static PresetGridMode presetGridMode = PresetGridMode.CREATE;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<CompletedGridCondition> completeConditions = GMShoreCache1Instance.completeConditions;
}
