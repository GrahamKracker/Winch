...
public static class ResearchMachineInstall
{
    public static QuestGridConfig ResearchMachineInstallInstance = (QuestGridConfig)System.Linq.Enumerable.First(ScriptableObjectInstances.QuestGridConfigs, x => x.name == "ResearchMachineInstall");
    public static QuestGridExitMode questGridExitMode = QuestGridExitMode.ITEM_DELIVER;
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString titleString = ResearchMachineInstallInstance.titleString;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString helpStringOverride = ResearchMachineInstallInstance.helpStringOverride;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString exitPromptOverride = ResearchMachineInstallInstance.exitPromptOverride;
     ///<json>
     /// null
     /// </json>
    ...
    public static float startingDurabilityProportion = 1f;
     ...
     ///}
     ///</json>
    public static GridConfiguration gridConfiguration = ResearchMachineInstallInstance.gridConfiguration;
     ///<json>
     /// {
     ...
     ///}
     ///</json>
    public static SerializableGrid presetGrid = ResearchMachineInstallInstance.presetGrid;
    public static PresetGridMode presetGridMode = PresetGridMode.SILHOUETTE;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<CompletedGridCondition> completeConditions = ResearchMachineInstallInstance.completeConditions;
}
