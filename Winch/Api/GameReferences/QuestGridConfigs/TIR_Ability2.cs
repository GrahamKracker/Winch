...
public static class TIR_Ability2
{
    public static QuestGridConfig TIR_Ability2Instance = (QuestGridConfig)System.Linq.Enumerable.First(ScriptableObjectInstances.QuestGridConfigs, x => x.name == "TIR_Ability2");
    public static QuestGridExitMode questGridExitMode = QuestGridExitMode.REVISITABLE;
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString titleString = TIR_Ability2Instance.titleString;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString helpStringOverride = TIR_Ability2Instance.helpStringOverride;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString exitPromptOverride = TIR_Ability2Instance.exitPromptOverride;
     ///<json>
     /// null
     /// </json>
    ...
    public static GridKey gridKey = GridKey.TIR_ABILITY_2;
    ...
    public static float startingDurabilityProportion = 1f;
     ...
     ///}
     ///</json>
    public static GridConfiguration gridConfiguration = TIR_Ability2Instance.gridConfiguration;
     ///<json>
     /// {
     ...
     ///}
     ///</json>
    public static SerializableGrid presetGrid = TIR_Ability2Instance.presetGrid;
    public static PresetGridMode presetGridMode = PresetGridMode.SILHOUETTE;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<CompletedGridCondition> completeConditions = TIR_Ability2Instance.completeConditions;
}
