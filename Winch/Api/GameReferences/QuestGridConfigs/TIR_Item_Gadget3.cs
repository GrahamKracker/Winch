...
public static class TIR_Item_Gadget3
{
    public static QuestGridConfig TIR_Item_Gadget3Instance = (QuestGridConfig)System.Linq.Enumerable.First(ScriptableObjectInstances.QuestGridConfigs, x => x.name == "TIR_Item_Gadget3");
    public static QuestGridExitMode questGridExitMode = QuestGridExitMode.REVISITABLE;
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString titleString = TIR_Item_Gadget3Instance.titleString;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString helpStringOverride = TIR_Item_Gadget3Instance.helpStringOverride;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString exitPromptOverride = TIR_Item_Gadget3Instance.exitPromptOverride;
     ///<json>
     /// null
     /// </json>
    ...
    public static GridKey gridKey = GridKey.TIR_GADGET_3;
    ...
    public static float startingDurabilityProportion = 1f;
     ...
     ///}
     ///</json>
    public static GridConfiguration gridConfiguration = TIR_Item_Gadget3Instance.gridConfiguration;
     ///<json>
     /// {
     ...
     ///}
     ///</json>
    public static SerializableGrid presetGrid = TIR_Item_Gadget3Instance.presetGrid;
    public static PresetGridMode presetGridMode = PresetGridMode.SILHOUETTE;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<CompletedGridCondition> completeConditions = TIR_Item_Gadget3Instance.completeConditions;
}
