...
{
    public static QuestGridConfig TIR_Samples4Instance = (QuestGridConfig)System.Linq.Enumerable.First(ScriptableObjectInstances.QuestGridConfigs, x => x.name == "TIR_Samples4");
    public static QuestGridExitMode questGridExitMode = QuestGridExitMode.REVISITABLE;
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString titleString = TIR_Samples4Instance.titleString;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString helpStringOverride = TIR_Samples4Instance.helpStringOverride;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString exitPromptOverride = TIR_Samples4Instance.exitPromptOverride;
     ///<json>
     /// null
     /// </json>
    ...
    public static GridKey gridKey = GridKey.TIR_SAMPLES_4;
    ...
    public static float startingDurabilityProportion = 1f;
     ...
     ///}
     ///</json>
    public static GridConfiguration gridConfiguration = TIR_Samples4Instance.gridConfiguration;
     ///<json>
     /// {
     ...
     ///}
     ///</json>
    public static SerializableGrid presetGrid = TIR_Samples4Instance.presetGrid;
    public static PresetGridMode presetGridMode = PresetGridMode.SILHOUETTE;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<CompletedGridCondition> completeConditions = TIR_Samples4Instance.completeConditions;
}
