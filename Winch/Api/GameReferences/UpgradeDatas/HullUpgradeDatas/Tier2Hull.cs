...
{
    public static HullUpgradeData Tier2HullInstance = (HullUpgradeData)System.Linq.Enumerable.First(ScriptableObjectInstances.UpgradeDatas, x => x.name == "Tier2Hull");
     ///<json>
     /// {
     ///    "cellGroupConfigs": [
     ///        {
     ...
     ///}
     ///</json>
    public static GridConfiguration hullGridConfiguration = Tier2HullInstance.hullGridConfiguration;
     ///<json>
     /// {
     ...
     ///}
     ///</json>
    public static UnityEngine.AddressableAssets.AssetReference engineAudioClip = Tier2HullInstance.engineAudioClip;
    public static int newCellCount = 5;
     ///<json>
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.Sprite hullSprite = Tier2HullInstance.hullSprite;
    public static string id = "";
    public static int tier = 2;
     ///<json>
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.Sprite sprite = Tier2HullInstance.sprite;
     ///<json>
     /// {
     ///    "$content": [
     ///        {
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UpgradeCost> upgradeCost = Tier2HullInstance.upgradeCost;
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<ItemCountCondition> itemCost = Tier2HullInstance.itemCost;
     ///<json>
     /// {
     ///    "$content": [
     ///        {
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UpgradeData> prerequisiteUpgrades = Tier2HullInstance.prerequisiteUpgrades;
}
