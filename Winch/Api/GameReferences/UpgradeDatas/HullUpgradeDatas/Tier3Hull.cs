...
public static class Tier3Hull
{
    public static HullUpgradeData Tier3HullInstance = (HullUpgradeData)System.Linq.Enumerable.First(ScriptableObjectInstances.UpgradeDatas, x => x.name == "Tier3Hull");
     ...
     ///}
     ///</json>
    public static GridConfiguration hullGridConfiguration = Tier3HullInstance.hullGridConfiguration;
     ///<json>
     /// {
     ...
     ///}
     ///</json>
    public static UnityEngine.AddressableAssets.AssetReference engineAudioClip = Tier3HullInstance.engineAudioClip;
    public static int newCellCount = 9;
     ///<json>
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.Sprite hullSprite = Tier3HullInstance.hullSprite;
    public static string id = "";
    public static int tier = 3;
     ///<json>
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.Sprite sprite = Tier3HullInstance.sprite;
     ///<json>
     /// {
     ///    "$content": [
     ///        {
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UpgradeCost> upgradeCost = Tier3HullInstance.upgradeCost;
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<ItemCountCondition> itemCost = Tier3HullInstance.itemCost;
     ///<json>
     /// {
     ///    "$content": [
     ///        {
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UpgradeData> prerequisiteUpgrades = Tier3HullInstance.prerequisiteUpgrades;
}
