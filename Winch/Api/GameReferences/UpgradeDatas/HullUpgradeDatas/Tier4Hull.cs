...
public static class Tier4Hull
{
    public static HullUpgradeData Tier4HullInstance = (HullUpgradeData)System.Linq.Enumerable.First(ScriptableObjectInstances.UpgradeDatas, x => x.name == "Tier4Hull");
     ///<json>
     /// {
     ///    "cellGroupConfigs": [
     ///        {
     ...
     ///}
     ///</json>
    public static GridConfiguration hullGridConfiguration = Tier4HullInstance.hullGridConfiguration;
     ///<json>
     /// {
     ...
     ///}
     ///</json>
    public static UnityEngine.AddressableAssets.AssetReference engineAudioClip = Tier4HullInstance.engineAudioClip;
    public static int newCellCount = 15;
     ///<json>
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.Sprite hullSprite = Tier4HullInstance.hullSprite;
    public static string id = "";
    public static int tier = 4;
     ///<json>
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.Sprite sprite = Tier4HullInstance.sprite;
     ///<json>
     /// {
     ///    "$content": [
     ///        {
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UpgradeCost> upgradeCost = Tier4HullInstance.upgradeCost;
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<ItemCountCondition> itemCost = Tier4HullInstance.itemCost;
     ///<json>
     /// {
     ///    "$content": [
     ///        {
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UpgradeData> prerequisiteUpgrades = Tier4HullInstance.prerequisiteUpgrades;
}
