...
public static class Tier1Engines1
{
    public static SlotUpgradeData Tier1Engines1Instance = (SlotUpgradeData)System.Linq.Enumerable.First(ScriptableObjectInstances.UpgradeDatas, x => x.name == "Tier1Engines1");
     ///<json>
     /// {
     ///    "$content": [
     ///        {
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<CellGroupConfiguration> cellGroupConfigs = Tier1Engines1Instance.cellGroupConfigs;
    public static string id = "";
    public static int tier = 1;
     ///<json>
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.Sprite sprite = Tier1Engines1Instance.sprite;
     ///<json>
     /// {
     ///    "$content": [
     ///        {
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UpgradeCost> upgradeCost = Tier1Engines1Instance.upgradeCost;
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<ItemCountCondition> itemCost = Tier1Engines1Instance.itemCost;
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UpgradeData> prerequisiteUpgrades = Tier1Engines1Instance.prerequisiteUpgrades;
}
