...
public static class Tier3Lights1
{
    public static SlotUpgradeData Tier3Lights1Instance = (SlotUpgradeData)System.Linq.Enumerable.First(ScriptableObjectInstances.UpgradeDatas, x => x.name == "Tier3Lights1");
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<CellGroupConfiguration> cellGroupConfigs = Tier3Lights1Instance.cellGroupConfigs;
    public static string id = "";
    public static int tier = 3;
     ///<json>
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.Sprite sprite = Tier3Lights1Instance.sprite;
     ///<json>
     /// {
     ///    "$content": [
     ///        {
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UpgradeCost> upgradeCost = Tier3Lights1Instance.upgradeCost;
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<ItemCountCondition> itemCost = Tier3Lights1Instance.itemCost;
     ///<json>
     /// {
     ///    "$content": [
     ///        {
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UpgradeData> prerequisiteUpgrades = Tier3Lights1Instance.prerequisiteUpgrades;
}
