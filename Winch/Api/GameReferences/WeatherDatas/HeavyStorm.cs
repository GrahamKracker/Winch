...
public static class HeavyStorm
{
    public static WeatherData HeavyStormInstance = (WeatherData)System.Linq.Enumerable.First(ScriptableObjectInstances.WeatherDatas, x => x.name == "HeavyStorm");
     ///<json>
     /// {
     ///    "durationHours": 6.0,
     ///    "cloudiness": 1.0,
     ...
     ///    "waveSteepness": 0.15,
     ///    "foamAmount": 0.35,
     ///    "lightningDelayMin": 5.0,
     ///    "lightningDelayMax": 10.0,
     ///    "weight": 2.0,
     ///    "sfx": {
     ///
     ///    },
     ...
     ///}
     ///</json>
    public static WeatherParameters parameters = HeavyStormInstance.parameters;
