...
public static class GhostBoat_Player2
{
    public static WorldEventData GhostBoat_Player2Instance = (WorldEventData)System.Linq.Enumerable.First(ScriptableObjectInstances.WorldEventDatas, x => x.name == "GhostBoat_Player2");
    public static WorldEventType eventType = WorldEventType.SPAWN_PREFAB;
     ///<json>
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.GameObject prefab = GhostBoat_Player2Instance.prefab;
    ...
    public static float maxSanity = 0.75f;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.Dictionary<GameMode,float> repeatDelay = GhostBoat_Player2Instance.repeatDelay;
    ...
    public static float minDepth = 0f;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UnityEngine.Vector3> depthTestPath = GhostBoat_Player2Instance.depthTestPath;
    ...
    public static ZoneEnum forbiddenZones = ZoneEnum.NONE | ZoneEnum.GALE_CLIFFS | ZoneEnum.TWISTED_STRAND | ZoneEnum.PALE_REACH;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<InventoryCondition> itemInventoryConditions = GhostBoat_Player2Instance.itemInventoryConditions;
