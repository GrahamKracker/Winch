...
{
    public static WorldEventData LeviathanCallInstance = (WorldEventData)System.Linq.Enumerable.First(ScriptableObjectInstances.WorldEventDatas, x => x.name == "LeviathanCall");
    public static WorldEventType eventType = WorldEventType.SPAWN_PREFAB;
     ///<json>
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.GameObject prefab = LeviathanCallInstance.prefab;
    ...
    public static float maxSanity = 1f;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.Dictionary<GameMode,float> repeatDelay = LeviathanCallInstance.repeatDelay;
    ...
    public static float minDepth = 0f;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UnityEngine.Vector3> depthTestPath = LeviathanCallInstance.depthTestPath;
    ...
    public static ZoneEnum forbiddenZones = ZoneEnum.NONE;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<InventoryCondition> itemInventoryConditions = LeviathanCallInstance.itemInventoryConditions;
