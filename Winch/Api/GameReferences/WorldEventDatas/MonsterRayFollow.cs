...
public static class MonsterRayFollow
{
    public static WorldEventData MonsterRayFollowInstance = (WorldEventData)System.Linq.Enumerable.First(ScriptableObjectInstances.WorldEventDatas, x => x.name == "MonsterRayFollow");
    public static WorldEventType eventType = WorldEventType.SPAWN_PREFAB;
     ///<json>
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.GameObject prefab = MonsterRayFollowInstance.prefab;
    ...
    public static float minSanity = 0.5f;
    public static float maxSanity = 0.75f;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.Dictionary<GameMode,float> repeatDelay = MonsterRayFollowInstance.repeatDelay;
    ...
    public static float minDepth = 0.05f;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UnityEngine.Vector3> depthTestPath = MonsterRayFollowInstance.depthTestPath;
    ...
    public static ZoneEnum forbiddenZones = ZoneEnum.NONE | ZoneEnum.TWISTED_STRAND | ZoneEnum.DEVILS_SPINE | ZoneEnum.PALE_REACH;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<InventoryCondition> itemInventoryConditions = MonsterRayFollowInstance.itemInventoryConditions;
