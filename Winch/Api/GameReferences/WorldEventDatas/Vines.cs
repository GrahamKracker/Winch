...
public static class Vines
{
    ...
    public static ZoneEnum forbiddenZones = ZoneEnum.NONE | ZoneEnum.THE_MARROWS | ZoneEnum.GALE_CLIFFS | ZoneEnum.STELLAR_BASIN | ZoneEnum.DEVILS_SPINE | ZoneEnum.OPEN_OCEAN | ZoneEnum.PALE_REACH;
     ///<json>
     /// {
     ///    "$content": [],
